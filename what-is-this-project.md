...
* <mark style="color:purple;background-color:purple;">**Validates → discusses → reasons → regenerates**</mark> with feedback until thresholds / max iterations.
* <mark style="color:purple;background-color:purple;">**LangGraph**</mark> - For multi agent workflow
* <mark style="color:purple;background-color:purple;">**Websearch**</mark> - Tavily
