...
* <mark style="color:purple;background-color:purple;">**Not required that every node should be an agent**</mark>
* <mark style="color:purple;background-color:purple;">**Self-reflection, discussion, orchestrated iteration support the label even if each step = fixed prompts + graph routing.**</mark>
